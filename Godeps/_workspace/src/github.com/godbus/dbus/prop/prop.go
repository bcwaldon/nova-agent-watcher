...
import (
	"github.com/coreos/nova-agent-watcher/Godeps/_workspace/src/github.com/godbus/dbus"
	"github.com/coreos/nova-agent-watcher/Godeps/_workspace/src/github.com/godbus/dbus/introspect"
	"sync"
)
